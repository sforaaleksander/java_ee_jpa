...
public class JPAExample {
    ...
    public static void populateDb(EntityManager em) {
        ...
        List<String> phoneNo1 = Arrays.asList("465424234".split(""));
        Student student = new Student("Ödön", "odon@tokodon.hu", birthDate1, address, classBp2, phoneNo1);
        ...
        List<String> phoneNo2 = Arrays.asList("234622".split(""));
        Student student2 = new Student("Aladár", "ktyfl@gmail.com", birthDate2, address2, classBp2, phoneNo2);
